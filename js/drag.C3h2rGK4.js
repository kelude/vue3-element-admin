import { d as defineComponent, c as computed, aP as toRefs, i as unref, r as ref, S as reactive, ab as h$1, B as getCurrentInstance, I as watch, o as onMounted, U as nextTick, b4 as onUnmounted, aA as isRef, g as createElementBlock, f as openBlock, m as createVNode, w as withCtx, Q as Fragment, R as renderList, F as toDisplayString, C as createBaseVNode, bV as TransitionGroup, a4 as createTextVNode } from "./index.CmLBO_Rw.js";
/* empty css                */
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
              ...
              default: withCtx(() => [
                createVNode(_component_el_card, { shadow: "never" }, {
                  header: withCtx(() => [..._cache[4] || (_cache[4] = [
                    createBaseVNode("span", { class: "card-header" }, "基础示例", -1)
                  ])]),
                  default: withCtx(() => [
                    createVNode(unref(lo), {
                      ref: "el",
                      modelValue: unref(userList),
                      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => isRef(userList) ? userList.value = $event : null),
              ...
              default: withCtx(() => [
                createVNode(_component_el_card, { shadow: "never" }, {
                  header: withCtx(() => [..._cache[5] || (_cache[5] = [
                    createBaseVNode("span", { class: "card-header" }, "过渡动画", -1)
                  ])]),
                  default: withCtx(() => [
                    createVNode(unref(lo), {
                      modelValue: unref(userList),
                      "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => isRef(userList) ? userList.value = $event : null),
                      target: ".sort-target",
                      scroll: true,
                      class: "drag-container"
                    }, {
        ...
        createVNode(_component_el_card, { shadow: "never" }, {
          header: withCtx(() => [..._cache[6] || (_cache[6] = [
            createBaseVNode("span", { class: "card-header" }, "表格拖拽排序", -1)
          ])]),
          default: withCtx(() => [
            createVNode(unref(lo), {
              modelValue: unref(userList),
              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => isRef(userList) ? userList.value = $event : null),
              target: "tbody",
              animation: 150
            }, {
              default: withCtx(() => [
        ...
        createVNode(_component_el_card, { shadow: "never" }, {
          header: withCtx(() => [..._cache[7] || (_cache[7] = [
            createBaseVNode("span", { class: "card-header" }, "指定元素拖拽排序", -1)
          ])]),
          default: withCtx(() => [
            createVNode(unref(lo), {
              modelValue: unref(userList),
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => isRef(userList) ? userList.value = $event : null),
              target: "tbody",
              handle: ".handle",
              animation: 150
            }, {
...
const drag = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3fe74c37"]]);
export {
  drag as default
};
