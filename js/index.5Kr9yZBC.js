...
import { E as ElCollapseTransition } from "./index.Fkfq50XD.js";
import { C as ClickOutside } from "./index.CF3ReAxE.js";
import { f as flattedChildren } from "./vnode.Cq1YVPHL.js";
import { E as ElDrawer } from "./drawer.CM8ZG6U9.js";
import { E as ElRadioGroup, a as ElRadio } from "./radio-group.YK7y6G_-.js";
import { E as ElSwitch } from "./switch.Bcg60GVJ.js";
import { u as useAriaProps, p as pick } from "./index.eINu-mWW.js";
import { U as UPDATE_MODEL_EVENT, C as CHANGE_EVENT } from "./event.BZTOGHfp.js";
import { u as useFormItem, a as useFormDisabled, b as useFormSize, c as useFormItemInputId } from "./use-form-common-props.DLum1V4R.js";
import { u as useFocusController } from "./index.DlY5bQhi.js";
import { d as debounce } from "./debounce.jyiH45I7.js";
import "./dropdown.vVNW_3Yn.js";
import "./castArray.DnojkoQZ.js";
import "./refs.CxYYXu5Q.js";
import "./index.CKZ7CIQk.js";
import "./index.DlUwldQ9.js";
import "./index.C_1JB0Ji.js";
import "./index.CORpYRAj.js";
import "./scroll.DVdS4xA0.js";
import "./index.CaGOe3Xg.js";
...
const COMPONENT_NAME$2 = "ElBacktop";
...
const _sfc_main$x = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const { handleClick, visible } = useBackTop(props, emit, COMPONENT_NAME$2);
...
const useSlider = (props, { key, minValue: minValue2, maxValue: maxValue2 }) => {
  ...
  function handleDrag(event) {
    ...
    if (!props.vertical) {
      ...
      value = Math.round((left - thumb.value.offsetWidth / 2) / (rect.width - thumb.value.offsetWidth) * maxValue2);
    } else {
      let top = clientY - rect.top;
      top = Math.max(thumb.value.offsetHeight / 2, top);
      top = Math.min(top, rect.height - thumb.value.offsetHeight / 2);
      value = Math.round((top - thumb.value.offsetHeight / 2) / (rect.height - thumb.value.offsetHeight) * maxValue2);
    }
...
const useSliderDOM = (props, {
  ...
  function getThumbLeft() {
    ...
    if (!el)
      return 0;
    return Math.round(value * (el.offsetWidth - thumb.value.offsetWidth / 2) / maxValue2);
  }
  function getThumbTop() {
    ...
    if (!el)
      return 0;
    return Math.round(value * (el.offsetHeight - thumb.value.offsetHeight / 2) / maxValue2);
  }
  function update() {
...
var HueSlider = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__file", "hue-slider.vue"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(rgbaColors), (item, index2) => {
...
var Predefine = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__file", "predefine.vue"]]);
...
var SvPanel = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["__file", "sv-panel.vue"]]);
